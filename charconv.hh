...
struct from_chars_result {
  const char* ptr; errc ec;
  friend bool operator==(const from_chars_result&, const from_chars_result&) = default;
};

to_chars_result to_chars(char* first, char* last, char value, int base = 10);
to_chars_result to_chars(char* first, char* last, wchar_t value, int base = 10);
to_chars_result to_chars(char* first, char* last, char8_t value, int base = 10);
to_chars_result to_chars(char* first, char* last, char16_t value, int base = 10);
to_chars_result to_chars(char* first, char* last, char32_t value, int base = 10);
...
from_chars_result from_chars(const char* first, const char* last, wchar_t& value, int base = 10);
from_chars_result from_chars(const char* first, const char* last, char8_t& value, int base = 10);
from_chars_result from_chars(const char* first, const char* last, char16_t& value, int base = 10);
from_chars_result from_chars(const char* first, const char* last, char32_t& value, int base = 10);
...
from_chars_result from_chars(const char* first, const char* last, bool& value, int base = 10);
