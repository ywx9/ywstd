...
YW_INTRIN_FUNC(void, _allow_cpu_features, unsigned __int64 a)
...
YW_INTRIN_FUNC(__int64, _bswap64, __int64 a)
YW_INTRIN_FUNC(unsigned __int32, _castf32_u32, float a)
YW_INTRIN_FUNC(unsigned __int64, _castf64_u64, double a)
YW_INTRIN_FUNC(float, _castu32_f32, unsigned __int32 a)
YW_INTRIN_FUNC(double, _castu64_f64, unsigned __int64 a)
YW_INTRIN_FUNC(__int32, _get_ssp, void)
YW_INTRIN_FUNC(__int64, _get_ssp, void)
YW_INTRIN_FUNC(void, _inc_ssp, unsigned int a)
YW_INTRIN_FUNC(int, _may_i_use_cpu_feature, unsigned __int64 a)
YW_INTRIN_FUNC(int, _popcnt32, int a)
YW_INTRIN_FUNC(int, _popcnt64, __int64 a)
YW_INTRIN_FUNC(__int64, _rdpmc, int a)
YW_INTRIN_FUNC(__int32, _rdsspd_i32, void)
YW_INTRIN_FUNC(__int64, _rdsspq_i64, void)
YW_INTRIN_FUNC(__int64, _rdtsc, void)
...
YW_INTRIN_FUNC(__int64, _mm_tzcnt_64, unsigned __int64 a)
...
YW_INTRIN_FUNC(__m256, _mm256_acos_ps, __m256 a)
...
YW_INTRIN_FUNC(unsigned char, _addcarry_u64, unsigned char c_in, unsigned __int64 a, unsigned __int64 b, unsigned __int64 * out)
YW_INTRIN_FUNC(unsigned char, _addcarryx_u32, unsigned char c_in, unsigned int a, unsigned int b, unsigned int * out)
YW_INTRIN_FUNC(unsigned char, _addcarryx_u64, unsigned char c_in, unsigned __int64 a, unsigned __int64 b, unsigned __int64 * out)
...
YW_INTRIN_FUNC(unsigned __int64, _andn_u64, unsigned __int64 a, unsigned __int64 b)
...
YW_INTRIN_FUNC(unsigned __int64, _bextr_u64, unsigned __int64 a, unsigned int start, unsigned int len)
YW_INTRIN_FUNC(unsigned int, _bextr2_u32, unsigned int a, unsigned int control)
YW_INTRIN_FUNC(unsigned __int64, _bextr2_u64, unsigned __int64 a, unsigned __int64 control)
YW_INTRIN_FUNC(unsigned char, _BitScanForward, unsigned __int32* index, unsigned __int32 a)
YW_INTRIN_FUNC(unsigned char, _BitScanForward64, unsigned __int32* index, unsigned __int64 a)
YW_INTRIN_FUNC(unsigned char, _BitScanReverse, unsigned __int32* index, unsigned __int32 a)
YW_INTRIN_FUNC(unsigned char, _BitScanReverse64, unsigned __int32* index, unsigned __int64 a)
YW_INTRIN_FUNC(unsigned char, _bittest, __int32* a, __int32 b)
YW_INTRIN_FUNC(unsigned char, _bittest64, __int64* a, __int64 b)
YW_INTRIN_FUNC(unsigned char, _bittestandcomplement, __int32* a, __int32 b)
YW_INTRIN_FUNC(unsigned char, _bittestandcomplement64, __int64* a, __int64 b)
YW_INTRIN_FUNC(unsigned char, _bittestandreset, __int32* a, __int32 b)
YW_INTRIN_FUNC(unsigned char, _bittestandreset64, __int64* a, __int64 b)
YW_INTRIN_FUNC(unsigned char, _bittestandset, __int32* a, __int32 b)
YW_INTRIN_FUNC(unsigned char, _bittestandset64, __int64* a, __int64 b)
...
YW_INTRIN_FUNC(unsigned __int64, _blsi_u64, unsigned __int64 a)
YW_INTRIN_FUNC(unsigned int, _blsmsk_u32, unsigned int a)
YW_INTRIN_FUNC(unsigned __int64, _blsmsk_u64, unsigned __int64 a)
YW_INTRIN_FUNC(unsigned int, _blsr_u32, unsigned int a)
YW_INTRIN_FUNC(unsigned __int64, _blsr_u64, unsigned __int64 a)
...
YW_INTRIN_FUNC(unsigned __int64, _bzhi_u64, unsigned __int64 a, unsigned int index)
...
inline __m256d _mm256_ceil_pd(__m256d a) noexcept { return _mm256_round_pd(a, 2); }
#else
...
YW_INTRIN_FUNC(void, _directstoreu_u64, void* dst, unsigned __int64 val)
...
YW_INTRIN_FUNC(__int32, _mm256_extract_epi32, __m256i a, const int index)
YW_INTRIN_FUNC(__int64, _mm256_extract_epi64, __m256i a, const int index)
...
YW_INTRIN_FUNC(__m128i, _mm_i32gather_epi64, __int64 const* base_addr, __m128i vindex, const int scale)
YW_INTRIN_FUNC(__m128i, _mm_mask_i32gather_epi64, __m128i src, __int64 const* base_addr, __m128i vindex, __m128i mask, const int scale)
YW_INTRIN_FUNC(__m256i, _mm256_i32gather_epi64, __int64 const* base_addr, __m128i vindex, const int scale)
YW_INTRIN_FUNC(__m256i, _mm256_mask_i32gather_epi64, __m256i src, __int64 const* base_addr, __m128i vindex, __m256i mask, const int scale)
...
YW_INTRIN_FUNC(__m128i, _mm_i64gather_epi64, __int64 const* base_addr, __m128i vindex, const int scale)
YW_INTRIN_FUNC(__m128i, _mm_mask_i64gather_epi64, __m128i src, __int64 const* base_addr, __m128i vindex, __m128i mask, const int scale)
YW_INTRIN_FUNC(__m256i, _mm256_i64gather_epi64, __int64 const* base_addr, __m256i vindex, const int scale)
YW_INTRIN_FUNC(__m256i, _mm256_mask_i64gather_epi64, __m256i src, __int64 const* base_addr, __m256i vindex, __m256i mask, const int scale)
...
YW_INTRIN_FUNC(__m256i, _mm256_insert_epi16, __m256i a, __int16 i, const int index)
YW_INTRIN_FUNC(__m256i, _mm256_insert_epi32, __m256i a, __int32 i, const int index)
YW_INTRIN_FUNC(__m256i, _mm256_insert_epi64, __m256i a, __int64 i, const int index)
YW_INTRIN_FUNC(__m256i, _mm256_insert_epi8, __m256i a, __int8 i, const int index)
...
#ifdef _loadbe_i64
#undef _loadbe_i64
inline __int64 _loadbe_i64(const void* ptr) noexcept { return (__int64)(_load_be_u64(ptr)); }
#else
YW_INTRIN_FUNC(__int64, _loadbe_i64, const void* ptr)
#endif
...
inline __m256i _mm256_loadu2_m128i(const __m128i* hiaddr, const __m128i* loaddr) noexcept
...
YW_INTRIN_FUNC(unsigned __int64, _lzcnt_u64, unsigned __int64 a)
...
YW_INTRIN_FUNC(__m128i, _mm_maskload_epi64, __int64 const* mem_addr, __m128i mask)
YW_INTRIN_FUNC(__m256i, _mm256_maskload_epi64, __int64 const* mem_addr, __m256i mask)
...
YW_INTRIN_FUNC(void, _mm_maskstore_epi64, __int64* mem_addr, __m128i mask, __m128i a)
YW_INTRIN_FUNC(void, _mm256_maskstore_epi64, __int64* mem_addr, __m256i mask, __m256i a)
...
YW_INTRIN_FUNC(unsigned __int64, _mulx_u64, unsigned __int64 a, unsigned __int64 b, unsigned __int64* hi)
...
YW_INTRIN_FUNC(unsigned __int64, _pdep_u64, unsigned __int64 a, unsigned __int64 mask)
...
YW_INTRIN_FUNC(unsigned __int64, _pext_u64, unsigned __int64 a, unsigned __int64 mask)
YW_INTRIN_FUNC(int, _mm_popcnt_u32, unsigned int a)
YW_INTRIN_FUNC(__int64, _mm_popcnt_u64, unsigned __int64 a)
...
YW_INTRIN_FUNC(void, _ptwrite64, unsigned __int64 a)
...
YW_INTRIN_FUNC(int, _rdrand64_step, unsigned __int64* val)
YW_INTRIN_FUNC(int, _rdseed16_step, unsigned short * val)
YW_INTRIN_FUNC(int, _rdseed32_step, unsigned int * val)
YW_INTRIN_FUNC(int, _rdseed64_step, unsigned __int64 * val)
YW_INTRIN_FUNC(unsigned __int64, __rdtscp, unsigned int * mem_addr)
YW_INTRIN_FUNC(unsigned int, _readfsbase_u32)
YW_INTRIN_FUNC(unsigned __int64, _readfsbase_u64)
YW_INTRIN_FUNC(unsigned int, _readgsbase_u32)
YW_INTRIN_FUNC(unsigned __int64, _readgsbase_u64)
...
YW_INTRIN_FUNC(unsigned __int64, _rotl64, unsigned __int64 a, int shift)
YW_INTRIN_FUNC(unsigned int, _rotr, unsigned int a, int shift)
YW_INTRIN_FUNC(unsigned __int64, _rotr64, unsigned __int64 a, int shift)
...
YW_INTRIN_FUNC(void, _senduipi, unsigned __int64 __a)
...
YW_INTRIN_FUNC(__m256i, _mm256_set_epi64x, __int64 e3, __int64 e2, __int64 e1, __int64 e0)
...
YW_INTRIN_FUNC(__m256i, _mm256_setr_epi64x, __int64 e3, __int64 e2, __int64 e1, __int64 e0)
...
#ifdef _storebe_i64
#undef _storebe_i64
inline void _storebe_i64(void* ptr, __int64 data) noexcept { _store_be_u64(ptr, (unsigned __int64)data); }
#else
YW_INTRIN_FUNC(void, _storebe_i64, void* ptr, __int64 data)
#endif
...
YW_INTRIN_FUNC(unsigned char, _subborrow_u64, unsigned char c_in, unsigned __int64 a, unsigned __int64 b, unsigned __int64 * out)
...
YW_INTRIN_FUNC(unsigned char, _tpause, unsigned int ctrl, unsigned __int64 counter)
...
YW_INTRIN_FUNC(unsigned __int64, _tzcnt_u64, unsigned __int64 a)
...
YW_INTRIN_FUNC(unsigned char, _umwait, unsigned int ctrl, unsigned __int64 counter)
...
YW_INTRIN_FUNC(void, _writefsbase_u64, unsigned __int64 a)
YW_INTRIN_FUNC(void, _writegsbase_u32, unsigned int a)
YW_INTRIN_FUNC(void, _writegsbase_u64, unsigned __int64 a)
YW_INTRIN_FUNC(void, _wrssd, __int32 val, void* p)
YW_INTRIN_FUNC(void, _wrssq, __int64 val, void* p)
YW_INTRIN_FUNC(void, _wrussd, __int32 val, void* p)
YW_INTRIN_FUNC(void, _wrussq, __int64 val, void* p)
...
YW_INTRIN_FUNC(unsigned __int64, _xgetbv, unsigned int a)
...
YW_INTRIN_FUNC(void, _xrstor, void* mem_addr, unsigned __int64 rs_mask)
YW_INTRIN_FUNC(void, _xrstor64, void* mem_addr, unsigned __int64 rs_mask)
YW_INTRIN_FUNC(void, _xrstors, const void* mem_addr, unsigned __int64 rs_mask)
YW_INTRIN_FUNC(void, _xrstors64, const void* mem_addr, unsigned __int64 rs_mask)
YW_INTRIN_FUNC(void, _xsave, void* mem_addr, unsigned __int64 save_mask)
YW_INTRIN_FUNC(void, _xsave64, void* mem_addr, unsigned __int64 save_mask)
YW_INTRIN_FUNC(void, _xsavec, void* mem_addr, unsigned __int64 save_mask)
YW_INTRIN_FUNC(void, _xsavec64, void* mem_addr, unsigned __int64 save_mask)
YW_INTRIN_FUNC(void, _xsaveopt, void* mem_addr, unsigned __int64 save_mask)
YW_INTRIN_FUNC(void, _xsaveopt64, void* mem_addr, unsigned __int64 save_mask)
YW_INTRIN_FUNC(void, _xsaves, void* mem_addr, unsigned __int64 save_mask)
YW_INTRIN_FUNC(void, _xsaves64, void* mem_addr, unsigned __int64 save_mask)
YW_INTRIN_FUNC(void, _xsetbv, unsigned int a, unsigned __int64 val)
